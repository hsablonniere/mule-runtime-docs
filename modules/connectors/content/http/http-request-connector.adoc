...
:page-id: mule-runtime@3.7::connectors:http/http-request-connector
...
|Enable Datasense |The *Enable DataSense* checkbox allows Studio to use xref:anypoint-studio@5::datasense/datasense#[DataSense] to expose metadata from the RAML file and interact with it on other elements in Studio.
|===
