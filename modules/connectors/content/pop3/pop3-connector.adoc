...
:page-id: mule-runtime@3.8::connectors:pop3/pop3-connector
...
See the xref:mule-runtime:transports/pop3-transport-reference#[POP3 Transport Reference] for details on setting the properties for a POP3 endpoint using an XML editor.
