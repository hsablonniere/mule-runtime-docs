...
:page-id: mule-runtime@3.7::connectors:ftp/ftp-connector
...
See the xref:mule-runtime:transports/ftp-transport-reference#[FTP Transport Reference] for details on setting the properties for an FTP endpoint using an XML editor.
