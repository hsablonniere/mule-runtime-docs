...
:page-id: mule-runtime@3.7::connectors:tls/tls-configuration
...
* See how to configure the xref:http/http-connector#[HTTP Connector]
* See how xref:http/authentication-in-http-requests#[authentication] works in the HTTP Connector
* Refer to the xref:mule-runtime:transports/https-transport-reference#[deprecated HTTPS Transport]
