...
:page-id: mule-runtime@3.7::connectors:web-service-consumer/web-service-consumer
...
For more information on best design-time practices with DataSense and DataWeave, consult the xref:anypoint-studio@5::datasense/datasense#[DataSense documentation].
...
Use the xref:anypoint-studio@5::datasense/using-the-datasense-explorer#[DataSense Explorer] feature in Studio to gain design-time insight into the state of the message payload, properties, and variables as it moves through your flow. The DataSense Explorer is most useful in understanding the content of a message before it encounters a Web Service Consumer, and after it emerges so as to better understand the state of the data your application is working with.
...
[TIP]
--
For a full list of elements, attributes and default values, consult the xref:web-service-consumer/web-service-consumer-reference#[Web Service Consumer Reference].
--
+
...
* Access the xref:mule-runtime:mule-fundamentals#[Mule Fundamentals] to learn the basics.