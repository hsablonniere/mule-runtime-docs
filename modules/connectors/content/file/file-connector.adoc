...
:page-id: mule-runtime@3.8::connectors:file/file-connector
...
*Reference*: xref:mule-runtime:transports/file-transport-reference#[File Transport Reference]
...
See the xref:mule-runtime:transports/file-transport-reference#[File Transport Reference] for details on setting the properties for a File endpoint using an XML editor.
