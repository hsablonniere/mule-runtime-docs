...
:page-id: mule-runtime@3.8::connectors:imap/imap-connector
...
See the xref:mule-runtime:transports/imap-transport-reference#[IMAP Transport Reference] for details on setting the properties for an IMAP endpoint using an XML editor.
