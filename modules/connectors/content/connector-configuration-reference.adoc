...
:page-id: mule-runtime@3.8::connectors:connector-configuration-reference
...
<<Configuring an Endpoint-Based Connector, Endpoint-Based>> connectors. For instructions on usage of a specific connector, consult the connector's documentation from the xref:anypoint-connectors#[Anypoint Connectors] page.



== Prerequisites

While you do not need full proficiency in Mule to configure connectors, you should be familiar with Mule and the xref:anypoint-studio@6::about-anypoint-studio#[Anypoint Studio interface]. If you have not done so already, cement your understanding of the Mule application design process, and Studio:

* xref:general@master::build-a-hello-world-application#[Build a Hello World Application]
* xref:anypoint-studio@6::basic-studio-tutorial#[Basic Studio Tutorial]


Further, it is best you attain a basic understanding of xref:mule-runtime:mule-concepts#[Mule Application Flows], xref:mule-runtime:mule-configuration/global-elements#[Global Elements], and xref:anypoint-connectors#[Anypoint Connectors] before moving on.



== Configuration Basics

When you add a connector configuration for a connector it is saved by default as a xref:mule-runtime:mule-configuration/global-elements#[Global Element]. This global element stores a *Connector Configuration* specific to a connector type, available from any instance of a connector of that type within the Mule app.
...
|===
|Field a|Description
|*Connector Configuration* |Define connection parameters here. This configuration gets saved in a xref:mule-runtime:mule-configuration/global-elements#[Global Element] that allows you use the connector configuration globally across the same type of connector.
...
Selected global connector configurations can also be defined as *Shared Resources* for a domain and referenced by all applications for that same domain. For more information, see xref:mule-runtime:shared-resources/domain-project-shared-resources#[Shared Resources].
...
* xref:mule-runtime:mule-configuration/configuring-properties#[Configuring Properties]
* Return to the xref:anypoint-connectors#[Anypoint Connectors] main page.
