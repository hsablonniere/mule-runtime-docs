...
:page-id: mule-runtime@3.8::connectors:sftp/sftp-connector
...
* Mule 3.8 and newer accepts SSH known_hosts files. For more information, see the xref:mule-runtime:transports/sftp-transport-reference#[SFTP Transport Reference].
...
See the xref:mule-runtime:transports/sftp-transport-reference#[SFTP Transport Reference] for details on setting the properties for an SFTP endpoint using an XML editor.
