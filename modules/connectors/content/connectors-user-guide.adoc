...
:page-id: mule-runtime@3.7::connectors:connectors-user-guide
...
* xref:installing-connectors#[Installing Connectors]
* xref:connector-configuration-reference#[Connector Configuration Reference]
* xref:working-with-multiple-versions-of-connectors#[Working with Multiple Versions of Connectors]
* xref:using-a-connector-to-access-an-oauth-api#[Using a Connector to Access an OAuth API]
* xref:auto-paging-in-anypoint-connectors#[Auto-Paging in Anypoint Connectors]
...
See the xref:connector-configuration-reference#[Connector Configuration Reference] for instructions for configuring connectors for endpoint functions or for operations.

See the xref:http/http-connector#[HTTP Connector] for information on this operation-based connector.
...
* Refer to the overview of xref:anypoint-connectors#[Anypoint Connectors].
* Access the link:http://www.mulesoft.org/connectors[full library of available connectors].
* Check out the xref:general@master::anypoint-connector#[Anypoint Connector quickstart]. 
