...
:page-id: mule-runtime@3.7::administer/jmx-management
...
There are several xref:administer/mule-agents#[agents] provided with Mule ESB for JMX support. The easiest way to configure JMX is to use the default JMX support agent.
...
* Subclass - link:http://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/module/management/agent/DefaultJmxSupportAgent.html[DefaultJmxSupportAgent] - This overrides the corresponding `createXXX()` factory methods.
