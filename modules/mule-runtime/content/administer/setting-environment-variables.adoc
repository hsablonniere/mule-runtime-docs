...
:page-id: mule-runtime@3.7::administer/setting-environment-variables
...
* Learn more about xref:shared-resources/domain-project-shared-resources#[Shared Resources]
* If you're deploying a single application, you can still set up xref:mule-configuration/configuring-properties#[Application Properties]
