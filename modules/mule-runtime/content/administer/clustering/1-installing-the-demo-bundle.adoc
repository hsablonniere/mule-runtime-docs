...
:page-id: mule-runtime@3.7::administer/clustering/1-installing-the-demo-bundle
...
. Download the link:https://s3.amazonaws.com/seteam/HA_DEMO/mule-ha-bundle-3.0.zip[*Mule HA Demo Bundle - mule-ha-bundle-3.0.zip*] and unzip it
