...
:page-id: mule-runtime@3.8::administer/clustering/distributed-locking
...
* Access xref:administer/clustering/mule-high-availability-ha-clusters#[Mule High Availability (HA) Clustering] for an overview.

* Learn how to xref:administer/clustering/creating-and-managing-a-cluster-manually#[manually create and manage a cluster,] accessing additional options.

* Learn how to enable xref:administer/clustering/distributed-file-polling#[distributed file polling].
