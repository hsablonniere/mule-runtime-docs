...
:page-id: mule-runtime@3.8::administer/clustering/creating-and-managing-a-cluster-manually
...
* Using Runtime Manager - for more information, see xref:anypoint-platform@latest::runtime-manager:managing-servers#create-a-cluster[Creating and Managing Clusters]
* Manually, using a configuration file

This page describes manual creation and configuration of a cluster. If you want to create and manage a cluster using the Management Console's graphical interface, see xref:mule-management-console@3.8::creating-or-disbanding-a-cluster#[Creating or Disbanding a Cluster].
...
[TIP]
--
Check xref:install/hardware-and-software-requirements#mule-database-servers[Mule's hardware and software requirements] for a list of supported relational database management systems.

Keep in mind that, from that list, Oracle database support is a xref:general@master::release-notes:mule-runtime/3.8.0-release-notes#enterprise-edition-known-issues-and-limitations[known limitation] for Mule 3.8.x and it is planned for a future release.
--
...
[CAUTION]
--
Oracle database support is a xref:general@master::release-notes:mule-runtime/3.8.0-release-notes#enterprise-edition-known-issues-and-limitations[known limitation] for Mule 3.8.x and it is planned for a future release.
--

== See Also

* Learn about
xref:mule-management-console@3.8::deploying-redeploying-or-undeploying-an-application-to-or-from-a-cluster#[deploying] and xref:mule-management-console@3.8::monitoring-a-cluster#[monitoring] clusters.
