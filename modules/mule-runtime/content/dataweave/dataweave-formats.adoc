...
:page-id: mule-runtime@3.8::dataweave/dataweave-formats
...
|`Collections/Array/Iterator/Iterable` | xref:dataweave/dataweave-types#array[:array]
|`String/CharSequence/Char/Enum/Class` | xref:dataweave/dataweave-types#string[:string]
|`int/Short/Long/BigInteger/Flat/Double/BigDecimal`|xref:dataweave/dataweave-types#number[:number]
|`Calendar/XmlGregorainCalendar`|xref:dataweave/dataweave-types#datetime[:datetime]
|`TimeZone`|xref:dataweave/dataweave-types#timezone[:timezone]
|`sql.Date/util.Date`|xref:dataweave/dataweave-types#date[:date]
|`Bean/Map`|xref:dataweave/dataweave-types#object[:object]
|`InputStream/Array[Byte]`|xref:dataweave/dataweave-types#boolean[:boolean]
|`java.lang.Boolean`|xref:dataweave/dataweave-types#binary[:binary]
...
[TIP]
See xref:anypoint-studio@6::using-dataweave-in-studio#defining-metadata-via-the-ui[Using DataWeave in Studio] for more detailed instructions on how to set this up.
...
See xref:anypoint-studio@6::using-dataweave-in-studio#reader-configuration[Using DataWeave in Studio] for more detailed instructions on how to set these properties.
...
[TIP]
====
See xref:dataweave/dataweave-flat-file-schemas#[DataWeave Flat File or EDI Schemas] for instructions and examples on how to create the required schema file.
====
...
[TIP]
See xref:dataweave/dataweave-flat-file-schemas#[Flat File Schemas] for more detailed instructions on how to write the required schema.
