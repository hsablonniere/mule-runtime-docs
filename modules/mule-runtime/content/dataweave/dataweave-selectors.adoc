...
:page-id: mule-runtime@3.8::dataweave/dataweave-selectors
...
xref:mel/mule-expression-language-mel#[Mule Expression Language (MEL)] expression.
...
You can take any *Outbound Properties* in the Mule message that arrives to the DataWeave transformer and use it in your transform body. To refer to it, simply call it through the matching xref:mel/mule-expression-language-mel#[Mule Expression Language (MEL)] expression.
