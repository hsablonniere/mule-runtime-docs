...
:page-id: mule-runtime@3.7::integration-patterns/understanding-enterprise-integration-patterns-using-mule
...
Mule supports most of the Enterprise Integration Patterns from the link:http://www.eaipatterns.com/toc.html[book] by Gregor Hohpe and Bobby Woolf.
...
|File Transfer |xref:transports/file-transport-reference#[File Transport]
|Shared Database |xref:transports/jdbc-transport-reference#[JDBC Transport]
...
|Message Router |xref:routers/routers#[Message Routers]
|Message Translator |xref:transformers/using-transformers#[Message Transformer]
|Message Endpoint |Inbound & Outbound xref:endpoints/endpoint-configuration-reference#[Endpoints]
|===
...
|===
|Pattern |Mapping to a Mule Object
|Content Enricher |xref:scopes/message-enricher#[Message Enricher]
|===
