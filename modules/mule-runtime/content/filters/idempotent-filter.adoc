...
:page-id: mule-runtime@3.8::filters/idempotent-filter
...
* See an example configuration on the xref:routers/routers#idempotent-message-filter[Routers] page
* xref:routers/routers#idempotent-secure-hash-message-filter[Secure Message Filter]
* xref:transactions/reliability-patterns#[Reliability Patterns]
