...
:page-id: mule-runtime@3.7::filters/message-filter
...
A Message Filter may also include nested filters. Nested filters let you apply more complex logic to the filter. See xref:filters/logic-filter#[Logic Filter] for more details about nesting filters.
