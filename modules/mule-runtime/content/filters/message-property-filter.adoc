...
:page-id: mule-runtime@3.8::filters/message-property-filter
...
You can also limit the filter to the scope of the message. The default scope is outbound. For more information about message scopes, see xref:mule-concepts#[Mule Concepts].
