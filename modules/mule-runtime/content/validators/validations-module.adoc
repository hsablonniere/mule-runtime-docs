...
:page-id: mule-runtime@3.8::validators/validations-module
...
[NOTE]
This feature is supported by the Mule runtime as of xref:general@master::release-notes:mule-runtime/3.7.0-release-notes#[Mule  3.7.0] in both Community and Enterprise editions. However, Studio support only became available starting with the September 2015 release.
