...
:page-id: mule-runtime@3.8::validators/json-schema-validator
...
* xref:connectors:web-service-consumer/web-service-consumer#[Web Service Consumer]
* xref:modules/json-module-reference#[JSON Module Reference]
* xref:anypoint-connector-devkit@3.7::about-devkit#[Anypoint Connector DevKit]