...
:page-id: mule-runtime@3.8::components/python-component-reference
...
When deploying to a customer managed Mule runtime (one that's deployed on-premises), then you can set the `python.path` property directly in the `wrapper.conf` file. See xref:mule-configuration/configuring-properties#system-properties[system properties] for a better understanding of how to set it.
...
* For more information see the Mule page xref:modules/scripting-module-reference#[Scripting Module].
