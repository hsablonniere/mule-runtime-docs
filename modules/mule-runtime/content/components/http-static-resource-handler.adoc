...
:page-id: mule-runtime@3.7::components/http-static-resource-handler
...
* Add some xref:routers/choice-flow-control-reference#[conditional logic] to your flow xref:routers/routers#[routers].