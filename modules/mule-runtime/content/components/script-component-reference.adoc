...
:page-id: mule-runtime@3.7::components/script-component-reference
...
[TIP]
Keep in mind that if you'd rather code in Java, there's also a xref:components/java-component-reference#[Java Component] that works very similarly.
...
* Read more about the xref:components/javascript-component-reference#[JavaScript Component]
* Read more about the xref:components/ruby-component-reference#[Ruby Component]
* Read more about the xref:components/groovy-component-reference#[Groovy Component]
* Read more about the xref:components/python-component-reference#[Python Component]
* Read more about the xref:components/java-component-reference#[Java Component]