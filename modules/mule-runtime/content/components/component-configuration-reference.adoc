...
:page-id: mule-runtime@3.7::components/component-configuration-reference
:keywords: anypoint, studio, esb, components

This page provides details on the elements you configure for components. This information is pulled directly from `mule.xsd` and is cached. For more information on components, see xref:components/configuring-components#[Configuring Components].
...
See xref:components/using-interceptors#[Using Interceptors].
