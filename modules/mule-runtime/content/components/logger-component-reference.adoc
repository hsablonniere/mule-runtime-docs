...
:page-id: mule-runtime@3.7::components/logger-component-reference
...
For instructions on how to edit these settings, see xref:debug/logging-in-mule#[Logging in Mule].

== See Also

* Read more about xref:debug/logging-in-mule#[Logging in Mule].
* Check the xref:mel/mule-expression-language-mel#[Mule Expression Language] reference for more ideas on how to format helpful logger messages.
