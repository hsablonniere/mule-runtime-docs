...
:page-id: mule-runtime@3.7::components/javascript-component-reference
...
[TIP]
Placing a JavaScript Component is actually the same as placing a xref:components/script-component-reference#[Script component] and then selecting the JavaScript engine.
