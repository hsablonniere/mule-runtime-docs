...
:page-id: mule-runtime@3.7::components/rest-component-reference
...
* If you intend to porxy an existing REST API, read xref:anypoint-platform@latest::api-manager:setting-up-an-api-proxy#[Proxying Your API].
