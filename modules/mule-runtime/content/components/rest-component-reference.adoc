...
:page-id: mule-runtime@3.8::components/rest-component-reference
...
* For an overview on the recommended ways to publish and consume REST services, see xref:api-usage/publishing-and-consuming-apis-with-mule#[Publishing and Consuming APIs with Mule]

* If you want to publish a REST API service, read about the xref:anypoint-platform@latest::api-manager:about-api-manager#[API Manager] to find out about a whole set of tools that will make this easier.

* If you intend to set up a proxy for an existing REST API, read xref:anypoint-platform@latest::api-manager:setting-up-an-api-proxy#[Setting up a proxyProxy].
