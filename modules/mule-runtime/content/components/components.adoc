...
:page-id: mule-runtime@3.8::components/components
...
See the xref:flows/flow-reference-component-reference#[Flow Reference Component Reference].
...
See the xref:components/logger-component-reference#[Logger Component Reference]
|===
...
See the xref:components/groovy-component-reference#[Groovy Component Reference].
...
See xref:components/java-component-reference#[Java Component].
...
See the xref:components/javascript-component-reference#[JavaScript Component Reference].
...
See the xref:components/python-component-reference#[Python Component Reference].
...
See the xref:components/ruby-component-reference#[Ruby Component Reference].
...
See the xref:components/script-component-reference#[Script Component Reference].
|===
...
See the xref:components/rest-component-reference#[REST Component Reference].
|image:cxf-component-icon.png[cxf-component-icon] |CXF |Makes a web service available to the application flow via CXF.

See the xref:components/cxf-component-reference#[CXF Component Reference].
|===
