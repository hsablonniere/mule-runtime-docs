...
:page-id: mule-runtime@3.7::components/ruby-component-reference
...
[TIP]
====
Placing a Ruby Component is actually the same as placing a xref:components/script-component-reference#[Script component] and then selecting the Ruby engine.
====
