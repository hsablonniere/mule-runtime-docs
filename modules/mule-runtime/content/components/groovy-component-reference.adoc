...
:page-id: mule-runtime@3.7::components/groovy-component-reference
...
[TIP]
Placing a Groovy Component is actually the same as placing a xref:components/script-component-reference#[Script component] and then selecting the Groovy engine.
...
* Refer to the generic xref:components/script-component-reference#[Script component reference page] to see how a script works with one-way and request-response connectors.
