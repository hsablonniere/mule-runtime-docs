...
:page-id: mule-runtime@3.7::components/java-component-reference
...
[TIP]
If all you really want to do with your java class is to modify the Payload of the message in some way, you're probably better off using a xref:transformers/java-transformer-reference#[Java Transformer] rather than a Java Component.
