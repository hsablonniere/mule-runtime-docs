...
:page-id: mule-runtime@3.8::components/http-response-builder
...
See xref:connectors:http/http-connector#[HTTP Connector] for information about the 3.6 and later operation-based HTTP connector. For information on the deprecated HTTP connector, see link:/mule-user-guide/v/3.8/http-connector-deprecated[HTTP Connector - Deprecated].
====
