...
:page-id: mule-runtime@3.8::components/cxf-component-reference
...
* Learn more about xref:api-usage/publishing-a-soap-api#[publishing SOAP APIs] with Mule.

* Learn more about xref:api-usage/consuming-a-soap-api#[consuming SOAP APIs] with Mule.
