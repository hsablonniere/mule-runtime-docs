...
:page-id: mule-runtime@3.8::mel/mule-expression-language-examples
...
This document assumes you are familiar with Mule Expression Language's xref:mel/mule-expression-language-basic-syntax#[basic syntax] and are comfortable building and running Mule applications using xref:anypoint-studio@6::about-anypoint-studio#[Mule Studio] or XML.

If you aren't yet familiar with how to access information about the Mule messages that pass through your applications, consider following this xref:messages/mule-message#[tutorial], which walks you through both examining your Mule message and its data structure and writing simple MEL expressions.
...
* Want to learn more about how to get information about the Mule message so that you can work with it using MEL? Try out this xref:messages/mule-message#[tutorial]. 