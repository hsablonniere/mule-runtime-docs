...
:page-id: mule-runtime@3.8::mel/mule-expression-language-date-and-time-functions
...
* xref:mel/mule-expression-language-examples#[Mule Expression Language Examples]

== Prerequisites

This document assumes you are familiar with xref:mel/mule-expression-language-mel#[Mule Expression Language (MEL)].  Further, this document assumes you are using Mule 3.4.0 or newer. 
...
|*xref:mel/mule-expression-language-date-and-time-functions#[Comparison]* a|
...
* Learn more about the xref:mel/mule-expression-language-mel#[Mule Expression Language (MEL)].
