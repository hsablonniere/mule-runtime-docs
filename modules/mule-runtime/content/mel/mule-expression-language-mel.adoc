...
:page-id: mule-runtime@3.7::mel/mule-expression-language-mel
...
This document assumes that you are familiar with Mule ESB and its xref:mule-concepts#[basic concepts]. Consider reading the chapter, xref:general@master::to-get-anypoint-platform#[Anypoint Fundamentals] to gain familiarity before proceeding. 
...
* Learn better by tutorial? Access the xref:@3.8::messages/mule-message#[Mule Message Tutorial].
