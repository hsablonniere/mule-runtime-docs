...
:page-id: mule-runtime@3.8::mel/mule-expression-language-basic-syntax
...
* Access a xref:messages/mule-message#[MEL tutorial] that walks you through the various ways you can use MEL expressions in a sample application.
