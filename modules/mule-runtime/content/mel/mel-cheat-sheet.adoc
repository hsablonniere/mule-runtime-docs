...
:page-id: mule-runtime@3.8::mel/mel-cheat-sheet
...
See also xref:mel/mule-expression-language-reference#[Mule Expression Language Reference].
...
For more information, see xref:modules/xpath#[XPath] and
xref:mel/mule-expression-language-reference#xpath[MEL XPath].
