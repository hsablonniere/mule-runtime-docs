...
:page-id: mule-runtime@3.8::api-usage/securing-a-soap-api
...
To the Mule flow that involves an API, add a xref:components/cxf-component-reference#[*CXF Component*] to publish, consume, or create a proxy for an API. Complete the following steps to configure WS-security on the CXF component.
