...
:page-id: mule-runtime@3.7::api-usage/using-mule-with-web-services
:keywords: cxf
...
* xref:api-usage/proxying-web-services#[Creating a proxy to existing Web services] (for example, adding security to an existing Web service)
