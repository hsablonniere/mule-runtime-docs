...
:page-id: mule-runtime@3.8::api-usage/using-mule-with-web-services
:keywords: cxf

[WARNING]
If you plan to connect to an external web service that exposes a WSDL file, the recommended connector to use is the xref:connectors:web-service-consumer/web-service-consumer#[Web Service Consumer].
...
* xref:api-usage/proxying-web-services#[Creating a proxy for existing Web services] (for example, adding security to an existing Web service)
...
[TIP]
As of the latest version of Mule ESB, the xref:modules/cxf-module-configuration-reference#[CXF Module] is the recommended way to work with with Web services.
...
. Generate a CXF client using the link:https://cwiki.apache.org/CXF20DOC/wsdl-to-java.html[WSDL to Java] tool from CXF or the link:http://cxf.apache.org/docs/maven-cxf-codegen-plugin-wsdl-to-java.html[Maven plugin].
...
For more information, you can check the xref:modules/consuming-web-services-with-cxf#[Consuming Web Services with CXF] documentation.
...
For more information, read the xref:modules/consuming-web-services-with-cxf#[Consuming Web Services with CXF] documentation.
...
* xref:modules/consuming-web-services-with-cxf#[Use the JAX-WS Client API].
* xref:modules/consuming-web-services-with-cxf#[Build a Client Proxy].
...
For more information, read the xref:modules/building-web-services-with-cxf#[Creating a JAX-WS Service] documentation.
...
For more information, read the xref:modules/building-web-services-with-cxf#[Creating a WSDL First JAX-WS Service] documentation.
...
For more information, read the xref:modules/building-web-services-with-cxf#[Creating a simple front-end Web service] documentation.
...
* xref:modules/proxying-web-services-with-cxf#[Server-side Proxying]
* xref:modules/proxying-web-services-with-cxf#[Client-side Proxying]
...
* xref:modules/cxf-module-reference#[CXF Module Reference]
* xref:modules/supported-web-service-standards#[Supported Web Service Standards]
* Examples
** Echo Example
** Bookstore Example
