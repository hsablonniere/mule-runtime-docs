...
:page-id: mule-runtime@3.8::api-usage/proxying-web-services
...
This type of bridge can be combined with filters for easy message routing. For fast XPath routing of messages, you can use the xref:modules/sxc-module-reference#[SXC Module Reference].
...
See the xref:modules/proxying-web-services-with-cxf#[Proxying Web Services with CXF] for more details.
