...
:page-id: mule-runtime@3.7::api-usage/publishing-and-consuming-apis-with-mule
...
* Learn more about xref:api-usage/publishing-a-soap-api#[Publishing a SOAP API] with CXF
...
* For more information on this new connector, see xref:connectors:web-service-consumer/web-service-consumer#[Web Service Consumer] .
* For a complete configuration reference, see xref:connectors:web-service-consumer/web-service-consumer-reference#[Web Service Consumer Reference].
...
* Follow the xref:apikit@3.8.3::apikit-tutorial#[APIkit Tutorial] to publish a sample RAML-based API.  
...
If either or both of these describes your use case, visit the xref:anypoint-connector-devkit@3.7::about-devkit#[DevKit] documentation to learn more about the process of building a connector.

==== Get Started:

* xref:api-usage/consuming-a-rest-api#[Consuming REST APIs] with HTTP
* Build a connector with xref:anypoint-connector-devkit@3.7::about-devkit#[Anypoint Connector DevKit]
