...
:page-id: mule-runtime@3.7::api-usage/using-.net-web-services-with-mule
...
For more information see xref:security/configuring-security#[Configuring Security].
...
If you are using CXF, you can configure a client and service to use WS-Security. For details, see xref:modules/enabling-ws-security#[Enabling WS-Security].
