...
:page-id: mule-runtime@3.8::api-usage/publishing-a-soap-api
:keywords: cxf
...
Using the Mule xref:modules/cxf-module-reference#[CXF Component], you can also xref:api-usage/securing-a-soap-api#[enable WS-security], specify data bindings, and add interceptors to your CXF API.
