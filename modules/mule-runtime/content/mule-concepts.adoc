...
:page-id: mule-runtime@3.8::mule-concepts
...
Within many of the fields of the message processors of your flow, you can use xref:mel/mule-expression-language-mel#[Mule Expression Language] to extract information about the message or its environment and instruct Mule to make processing decisions based on that information.
...
* xref:mel/mule-expression-language-mel#[Mule Expression Language]
* xref:mel/mule-expression-language-basic-syntax#[Mule Expression Language Basic Syntax]
...
* xref:anypoint-platform@latest::exchange:anypoint-exchange#[Examples]



== See Also

* *NEXT STEP:* Learn more about the xref:flows/elements-in-a-mule-flow#[elements in a Mule flow].
* Find out more about xref:batch/batch-processing#[Batch Processing]. +
