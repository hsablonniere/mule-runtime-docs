...
:page-id: mule-runtime@3.7::scopes/request-reply-scope
...
This document assumes that you understand the difference between xref:flows/flows-and-subflows#[synchronous and asynchronous flows]. Furthermore, you're also familiar with xref:scopes/scopes#[Scopes] in general.
...
* Learn more about xref:flows/flows-and-subflows#[synchronous and asynchronous flows].