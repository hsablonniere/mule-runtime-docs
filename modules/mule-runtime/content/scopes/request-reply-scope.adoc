...
:page-id: mule-runtime@3.8::scopes/request-reply-scope
...
This document assumes that you understand the difference between xref:flows/flows-and-subflows#[synchronous and asynchronous flows]. Furthermore, review xref:scopes/scopes#[Scopes] in general.
