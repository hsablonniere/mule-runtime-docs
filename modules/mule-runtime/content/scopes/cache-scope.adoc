...
:page-id: mule-runtime@3.8::scopes/cache-scope
...
By default, Mule stores all cached responses in an InMemoryObjectStore. xref:ccs[Create a Caching Strategy] and define a new xref:modules/mule-object-stores#[object store] if you want to customize the way Mule stores cached responses.
