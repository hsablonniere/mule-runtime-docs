...
:page-id: mule-runtime@3.7::scopes/async-scope-reference
...
An async scope is similar to an *xref:flows/flows-and-subflows#[asynchronous flow]* in that:
...
An async scope is similar to a *xref:flows/flows-and-subflows#[subflow]* in that it inherits the exception strategy of the main flow. 
...
For more information about processing strategies, see xref:flows/flow-processing-strategies#[Flow Processing Strategies].
...
+
. Configure the processing strategy as needed. For more information, see xref:flows/flow-processing-strategies#[Flow Processing Strategies].

[discrete.view]
=== XML Editor or Standalone

. Define your processing strategy as a global element, with any necessary configuration or optional fine-tuning. (For more information, see xref:flows/flow-processing-strategies#[Flow Processing Strategies].) Refer to code sample below.
...
* For more information about processing strategies and how to configure them, see xref:flows/flow-processing-strategies#[Flow Processing Strategies].