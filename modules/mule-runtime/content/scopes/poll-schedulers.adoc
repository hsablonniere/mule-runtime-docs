...
:page-id: mule-runtime@3.7::scopes/poll-schedulers
...
This document assumes that your are familiar with xref:anypoint-studio@5::about-anypoint-studio#[Anypoint Studio] and link:http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about xref:scopes/poll-reference#[poll scopes] in Mule.
...
* Learn more about xref:scopes/poll-reference#[Poll Scopes] in Mule.
* Reference xref:mel/mule-expression-language-mel#[Mule Expression Language MEL].
* Learn more about xref:mel/mule-expression-language-date-and-time-functions#[MEL Date and Time Functions].