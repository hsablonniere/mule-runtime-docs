...
:page-id: mule-runtime@3.8::scopes/poll-schedulers
...
This document assumes that your are familiar with xref:anypoint-studio@6::about-anypoint-studio#[Anypoint Studio] and link:http://en.wikipedia.org/wiki/Polling_(computer_science)[polling] in general.  Read more about xref:scopes/poll-reference#[poll scopes] in Mule.
