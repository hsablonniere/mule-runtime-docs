...
:page-id: mule-runtime@3.7::scopes/poll-reference
...
|You must create a Twitter connector as a xref:mule-configuration/global-elements#[global element] to reference here. For your Twitter connector, you need a Twitter developer account.
|===
+
...
. Run your project in Debug Mode. (Refer to the xref:anypoint-studio@5::studio-visual-debugger#[Visual Debugger] document for greater detail.)
