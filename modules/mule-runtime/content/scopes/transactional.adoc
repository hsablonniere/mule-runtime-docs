...
:page-id: mule-runtime@3.8::scopes/transactional
...
For more information and full details about how to demarcate transactions in your Mule flow, refer to xref:transactions/transaction-management#[Transaction Management].
