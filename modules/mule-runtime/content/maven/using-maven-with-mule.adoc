...
:page-id: mule-runtime@3.7::maven/using-maven-with-mule
...
* xref:anypoint-studio@5::maven/building-a-mule-application-with-maven-in-studio#[Building a Mule application with Maven in Studio]
...
* xref:anypoint-studio@5::maven/importing-a-maven-project-into-studio#[Importing a Maven project into Studio]
...
[TIP]
For info on how to use Maven in the context of Anypoint Sutio, MuleSoft's IDE for developing integration applications, see xref:anypoint-studio@5::maven/using-maven-in-anypoint-studio#[Use Maven in Anypoint Studio]
...
* Learn more about xref:anypoint-studio@5::maven/maven-support-in-anypoint-studio#[adjusting your Studio Preferences to work with Maven]. 
* Learn more about xref:anypoint-studio@5::maven/importing-a-maven-project-into-studio#[importing Maven projects into Studio] or link:/mule-user-guide/v/3.7/enabling-maven-support-for-a-studio-project["mavenizing" existing Studio projects].
