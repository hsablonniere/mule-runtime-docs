...
:page-id: mule-runtime@3.7::maven/maven-reference
:keywords: studio, maven, esb, version control, dependencies, libraries

This page summarizes reference information that is helpful for working with Maven and Mule. Refer to xref:maven/using-maven-with-mule#[Using Maven with Mule] for an introduction and overview.
...
See xref:maven/configuring-maven-to-work-with-mule-esb#[Configuring Maven to Work with Mule ESB].
...
* link:https://github.com/mulesoft/maven-mule-plugin[Mule plugin for Maven at Codehaus]
