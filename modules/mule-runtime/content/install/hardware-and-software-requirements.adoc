...
:page-id: mule-runtime@3.7::install/hardware-and-software-requirements
...
[TIP]
For Hardware and Software requirements of Anypoint Studio, MuleSoft's IDE for building integration applications, see xref:anypoint-studio@5::hardware-and-software-requirements#[Studio Hardware and Software Requirements].
...
* Learn how to xref:install/downloading-and-starting-mule-esb#[download, install, and launch] Mule.
* Learn more about installing an xref:install/installing-an-enterprise-license#[Enterprise license].
* xref:general@master::to-get-anypoint-platform#[Get started] with Anypoint Studio.
