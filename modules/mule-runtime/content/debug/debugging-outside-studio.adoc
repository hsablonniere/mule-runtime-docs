...
:page-id: mule-runtime@3.7::debug/debugging-outside-studio
:keywords: debugging, debug

In Anypoint Studio, you can use the xref:anypoint-studio@5::studio-visual-debugger#[Studio Visual Debugger] to help you troubleshoot your app. If you're creating your Mule app outside Studio, you can resort to the following options:
