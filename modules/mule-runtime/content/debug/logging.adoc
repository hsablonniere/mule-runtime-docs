...
:page-id: mule-runtime@3.7::debug/logging
...
You can configure what gets logged, where it gets logged, and how by editing a configuration file that sits in your project. For a description of what you can do through this and instructions on how to set it up, see xref:debug/logging-in-mule#[Logging in Mule].
