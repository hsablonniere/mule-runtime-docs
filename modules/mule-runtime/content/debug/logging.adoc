...
:page-id: mule-runtime@3.8::debug/logging
...
You can configure what gets logged, where it gets logged, and how by editing a configuration file from your Studio project or in a folder in your standalone Mule server's `$MULE_HOME` directory. For instructions on how to modify the file, see xref:debug/logging-in-mule#[Logging in Mule].

== See Also

* For more on how to use the Logger component in Studio, see xref:components/logger-component-reference#[Logger Component Reference]
