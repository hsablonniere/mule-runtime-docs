...
:page-id: mule-runtime@3.8::security/authorization-grant-types
...
The sections below offer brief descriptions of each type of authorization grant, listed according to the level of security, in descending order. Refer to the xref:security/mule-secure-token-service#[Mule Secure Token Service] document for details regarding OAuth Roles and the OAuth dance.
