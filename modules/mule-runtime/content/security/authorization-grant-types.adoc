...
:page-id: mule-runtime@3.7::security/authorization-grant-types
...
The sections below offer brief descriptions of each type of authorization grant, listed according to the level of security, in descending order. Refer to the link:/mule-user-guide/v/3.7/mule-secure-token-service[Mule Secure Token Service] document for details regarding OAuth Roles and the OAuth dance.
