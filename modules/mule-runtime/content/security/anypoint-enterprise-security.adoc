...
:page-id: mule-runtime@3.8::security/anypoint-enterprise-security
...
xref:security/mule-secure-token-service#[Apply Oauth 2.0 to my Mule Web service provider] +
xref:security/mule-secure-token-service#[Apply Oauth 2.0 to my Mule Web service consumer]
