...
:page-id: mule-runtime@3.7::security/anypoint-enterprise-security
...
Install the xref:security/installing-anypoint-enterprise-security#[Anypoint Enterprise Security update] on your instance of Anypoint Studio Enterprise Edition 3.3.2 or later.
...
* xref:security/configuring-the-spring-security-manager#[Mule Security Manager], client authentication and authorization on inbound requests as well as credential mapping for outbound calls
* xref:security/setting-up-ldap-provider-for-spring-security#[LDAP] and third party identity management system integration
* xref:modules/enabling-ws-security#[Validation of inbound requests] through the SAML 2.0 federated identity standard
* xref:transports/sftp-transport-reference#[Secure FTP (SFTP) Transport] that enables Mule flows to read and write to remote directories over the SSH protocol.
...
link:/mule-user-guide/v/3.7/mule-secure-token-service[Apply Oauth 2.0 to my Mule Web service provider] +
link:/mule-user-guide/v/3.7/mule-secure-token-service[Apply Oauth 2.0 to my Mule Web service consumer]
...
xref:security/mule-credentials-vault#[Encrypt a properties file]
...
xref:security/mule-message-encryption-processor#[Encrypt a message payload] +
xref:security/mule-message-encryption-processor#[Decrypt a message payload]
...
xref:security/mule-digital-signature-processor#[Add a digital signature to a message in Mule] +
xref:security/mule-digital-signature-processor#[Sign part of a message payload] +
xref:security/mule-digital-signature-processor#[Verify a digital signature in Mule]
...
xref:security/anypoint-filter-processor#[Filter unsecure messages]
...
xref:security/mule-crc32-processor#[Apply a CRC to a message] +
 +

== See Also

. Install the xref:security/installing-anypoint-enterprise-security#[Anypoint Enterprise Security update] on your instance of Anypoint Studio or Standalone Enterprise 3.3.2 or later.
...
** xref:security/anypoint-enterprise-security-example-application#[Anypoint Enterprise Security Example Application]
** xref:security/mule-sts-oauth-2.0-example-application#[Mule STS Oauth 2.0 Example Application]
