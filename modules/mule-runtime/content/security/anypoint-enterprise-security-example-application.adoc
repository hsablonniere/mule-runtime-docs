...
:page-id: mule-runtime@3.7::security/anypoint-enterprise-security-example-application
...
It also assumes you are familiar with the xref:anypoint-studio@5::about-anypoint-studio#[Anypoint Studio] interface. To increase your familiarity with Studio, consider completing one or more xref:general@master::to-get-anypoint-platform#[Anypoint Studio Quickstarts].
