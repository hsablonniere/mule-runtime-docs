...
:page-id: mule-runtime@3.8::security/mule-message-encryption-processor
...
Mule has the ability to encrypt a message payload, or part of a payload, using link:http://www.pgpi.org/doc[Pretty Good Privacy (PGP)].

[NOTE]
Because of its increased complexity, the topic has earned its own page: refer to the xref:security/pgp-encrypter#[PGP Encrypter] document. 
