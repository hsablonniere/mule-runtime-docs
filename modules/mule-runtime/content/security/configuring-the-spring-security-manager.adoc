...
:page-id: mule-runtime@3.8::security/configuring-the-spring-security-manager
...
You can use any of the library's security providers such as JAAS, LDAP, CAS (Yale Central Authentication service), and DAO. For more information on the elements you can configure for a security manager, see xref:security/security-manager-configuration-reference#[Security Manager Configuration Reference].
