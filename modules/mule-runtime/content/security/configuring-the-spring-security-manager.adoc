...
:page-id: mule-runtime@3.7::security/configuring-the-spring-security-manager
:keywords: anypoint, studio, esb, on premises, on premise, security, amc, aes, spring security

Use Spring Security 3.0 as a Security Manager inside of Mule. You can use any of the library's security providers such as JAAS, LDAP, CAS (Yale Central Authentication service), and DAO. For more information on the elements you can configure for a Mule security manager, see xref:security/security-manager-configuration-reference#[Security Manager Configuration Reference].
