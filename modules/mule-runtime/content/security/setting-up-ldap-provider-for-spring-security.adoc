...
:page-id: mule-runtime@3.8::security/setting-up-ldap-provider-for-spring-security
...
* To perform xref:security/component-authorization-using-spring-security#[component authorization]

For information on configuring an in-memory provider, see xref:security/configuring-security#[Configuring Security].
...
The configuration for component authorization is similar to the one described in xref:security/component-authorization-using-spring-security#[Component Authorization Using Spring Security]. A key point of configuration is `securityMetadataSource`:
