...
:page-id: mule-runtime@3.7::security/mule-crc32-processor
...
. Click the image:<missing>documentation/s/en_GB/3391/c989735defd8798a9d5e69c058c254be2e5a762b.76/_/images/icons/emoticons/add.png[(plus)] icon next to the** *Connector Configuration*** field.
