...
:page-id: mule-runtime@3.7::security/pgp-encrypter
...
* Learn how to encrypt your properties file with the xref:security/mule-credentials-vault#[Mule Credentials Vault].
* Learn how to encrypt or decrypt messages with xref:security/mule-message-encryption-processor#[XML or JCE Encryption].
