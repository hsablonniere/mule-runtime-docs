...
:page-id: mule-runtime@3.7::security/mule-sts-oauth-2.0-example-application
...
This document assumes that you are familiar with the xref:anypoint-studio@5::about-anypoint-studio#[Anypoint Studio interface]. To increase your familiarity with Anypoint Studio, consider completing one or more xref:general@master::to-get-anypoint-platform#[Anypoint Studio Quickstarts].
...
* For more information on Oauth 2.0 in Mule, refer to link:/mule-user-guide/v/3.7/mule-secure-token-service[Mule Secure Token Service].
