...
:page-id: mule-runtime@3.8::security/saml-module
...
Mule's xref:modules/cxf-module-reference#[CXF Module] includes WS-Security with a SAML option that supports SAML 2.0. 
====
