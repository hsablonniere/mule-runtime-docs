...
:page-id: mule-runtime@3.8::security/fips-140-2-compliance-support
...
xref:security/anypoint-enterprise-security#[Anypoint Enterprise Security] version 1.3 supports FIPS security mode. When in FIPS security mode, Mule will not register a security provider, allowing the module to rely on the platform security provider.
