...
:page-id: mule-runtime@3.7::security/anypoint-filter-processor
...
NOTE: This topic introduces the idea of Global Elements; if you are unfamiliar with this functionality, access xref:mule-configuration/global-elements#[Understand Global Elements] to learn more before proceeding.
