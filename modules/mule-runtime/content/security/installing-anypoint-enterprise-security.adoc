...
:page-id: mule-runtime@3.8::security/installing-anypoint-enterprise-security
...
* You are using Mule with a valid Enterprise license. (Learn more about xref:install/installing-an-enterprise-license#[installing an Enterprise license] on your existing instance of Mule.)
...
* Refer to the xref:general@master::release-notes:anypoint-enterprise-security/release-notes#[Anypoint Enterprise Security Release Notes] for details about what is included with each version.
