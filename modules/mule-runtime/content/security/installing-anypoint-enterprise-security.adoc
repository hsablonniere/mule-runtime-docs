...
:page-id: mule-runtime@3.7::security/installing-anypoint-enterprise-security
...
* Anypoint Enterprise Security requires Mule Enterprise version 3.3.2 or newer.  (Not sure which version of Mule you have installed? xref:install/installing#[Find out].)
...
* You are using Mule ESB with a valid Enterprise license. (Learn more about xref:install/installing-an-enterprise-license#[installing an Enterprise license] on your existing instance of Mule.)
...
* Refer to the xref:general@master::release-notes:anypoint-enterprise-security/release-notes#[Anypoint Enterprise Security Release Notes] for details about what is included in the current version.
