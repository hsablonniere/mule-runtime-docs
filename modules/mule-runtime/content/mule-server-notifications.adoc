...
:page-id: mule-runtime@3.8::mule-server-notifications
...
For a list of notification types, see xref:mule-configuration/notifications-configuration-reference#[Notifications Configuration Reference]. For a list of notification listener interfaces, see <<Notification Interfaces>> below.
...
For a list of the action codes available with each notification type, see the Javadocs for the link:http://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/context/notification/package-summary.html[org.mule.context.notification] package and click on the class of the notification type you want.
