...
:page-id: mule-runtime@3.7::deploy/application-server-based-hot-deployment
...
To deploy Mule as a service to Tomcat or Tcat Server, see xref:deploy/deploying-mule-as-a-service-to-tomcat#[Deploying Mule as a Service to Tomcat].
