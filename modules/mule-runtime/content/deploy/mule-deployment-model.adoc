...
:page-id: mule-runtime@3.7::deploy/mule-deployment-model
...
* xref:deploy/hot-deployment#[Hot Deployment]
* xref:deploy/application-deployment#[Application Deployment]
* xref:deploy/application-format#[Application Format]
