...
:page-id: mule-runtime@3.8::deploy/deploying-mule-as-a-service-to-tomcat
...
For more information on hot deploying Mule applications, see xref:deploy/application-server-based-hot-deployment#[Application Server Based Hot Deployment].
...
. Package your Mule application's configuration files and custom Java classes in a `.war` file (see xref:deploy/application-server-based-hot-deployment#[Application Server Based Hot Deployment]).
...
* Learn about deploying Mule applications in the cloud with xref:anypoint-platform@latest::cloudhub:cloudhub#[CloudHub].
