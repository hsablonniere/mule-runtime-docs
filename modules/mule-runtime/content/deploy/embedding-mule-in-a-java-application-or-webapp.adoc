...
:page-id: mule-runtime@3.8::deploy/embedding-mule-in-a-java-application-or-webapp
...
To interact with the Mule server from your application, JSP, or servlet, you can use the xref:administer/using-the-mule-client#[Mule Client].
