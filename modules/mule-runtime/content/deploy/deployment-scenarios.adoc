...
:page-id: mule-runtime@3.8::deploy/deployment-scenarios
...
For more information on deploing Mule apps, see xref:deploy/mule-deployment-model#[Mule App Deployment Model].
