...
:page-id: mule-runtime@3.8::non-mel-expressions/using-non-mel-expressions
...
Mule provides several xref:non-mel-expressions/non-mel-expressions-configuration-reference#[default expression evaluators], allowing you to embed expression logic in a variety of expression languages, or you can xref:non-mel-expressions/creating-non-mel-expression-evaluators#[create your own evaluators] to support additional languages.

This page describes how to use expressions. For more details on how to configure expressions, see xref:non-mel-expressions/non-mel-expressions-configuration-reference#[Non-MEL Expressions Configuration Reference].

== Message Property Scopes

Starting with Mule 3 expressions operating on message properties also support an optional scope qualifier syntax. For more information about message scopes, see xref:mule-concepts#[Mule Concepts].

== Using Expressions with Transformers

This section describes the transformers that support expressions. For more information on transformers, see xref:transformers/using-transformers#[Using Transformers].
...
To read more about configuring expressions, see xref:non-mel-expressions/non-mel-expressions-configuration-reference#[Non-MEL Expressions Configuration Reference].
