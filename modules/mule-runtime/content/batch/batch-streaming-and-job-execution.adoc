...
:page-id: mule-runtime@3.8::batch/batch-streaming-and-job-execution
...
* Access the xref:batch/batch-processing#[full documentation for Batch Processing] for the latest general availability release of Mule.
* For more information on best design-time practices with DataSense and DataMapper, consult the xref:anypoint-studio@6::datasense/datasense#[DataSense documentation].