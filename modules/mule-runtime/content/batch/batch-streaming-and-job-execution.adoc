...
:page-id: mule-runtime@3.7::batch/batch-streaming-and-job-execution
...
* For more information on best design-time practices with DataSense and DataMapper, consult the xref:anypoint-studio@5::datasense/datasense#[DataSense documentation].