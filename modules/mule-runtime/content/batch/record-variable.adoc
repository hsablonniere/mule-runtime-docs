...
:page-id: mule-runtime@3.8::batch/record-variable
...
This document assumes that you are familiar with xref:anypoint-studio@6::about-anypoint-studio#[Anypoint Studio] and have reviewed the overview and basic anatomy of xref:batch/batch-processing#[Batch Processing]. 
