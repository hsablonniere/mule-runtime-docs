...
:page-id: mule-runtime@3.8::batch/using-mel-with-batch-processing
:keywords: anypoint studio, studio, mule esb, batch


All of the functions and attributes below are usable within xref:mel/mule-expression-language-mel#[MEL] expressions anywhere in Mule where the context makes sense.
...
* Read more about using xref:mel/mule-expression-language-mel#[Mule Expression Language (MEL)]in your application
