...
:page-id: mule-runtime@3.7::transports/file-transport-reference
...
For new dateTime functions introduced into MEL with Mule 3.4 and later, see xref:mel/mule-expression-language-date-and-time-functions#[MEL Date and Time Functions]. 
