...
:page-id: mule-runtime@3.8::transports/wsdl-connectors
:keywords: cxf, axis
...
The Axis and xref:modules/cxf-module-reference#[CXF] transports provide WSDL connectors that can be used for invoking remote web services by obtaining the service WSDL. Mule creates a dynamic proxy for the service and then invokes it. The easiest tool for doing this, however, is the xref:connectors:web-service-consumer/web-service-consumer#[Web Service Consumer].
...
* link:http://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/cxf/wsdl/package-summary.html[Javadoc for CXF WSDL connector]
