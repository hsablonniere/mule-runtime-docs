...
:page-id: mule-runtime@3.8::transports/ejb-transport-reference
...
EJB endpoints are configured the same way as xref:transports/rmi-transport-reference#[RMI endpoints].
