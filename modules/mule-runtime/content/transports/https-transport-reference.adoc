...
:page-id: mule-runtime@3.8::transports/https-transport-reference
...
For more information on configuring HTTP endpoints, see xref:transports/deprecated-http-transport-reference#[HTTP Transport Reference].
