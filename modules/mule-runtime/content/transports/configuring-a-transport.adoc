...
:page-id: mule-runtime@3.8::transports/configuring-a-transport
...
For information on creating a custom transport for Mule, see xref:transports/creating-transports#[Creating Transports].
