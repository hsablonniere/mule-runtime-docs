...
http://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/servlet/ServletConnector.html[Mule Servlet Transport Javadoc]
...
For more information about using Mule with servlet containers, see xref:deploy/embedding-mule-in-a-java-application-or-webapp#[Embedding Mule in a Java Application or Webapp]. 
...
Servlet endpoints accept the same attributes and child elements as HTTP endpoints. For more information, see xref:transports/file-transport-reference#[FTP Transport Reference].
