...
:page-id: mule-runtime@3.8::transports/jetty-ssl-transport
:keywords: mule, esb, studio, jetty, SSL

The Jetty SSL transport works exactly the same way as the xref:transports/https-transport-reference#[HTTPS Transport Reference].
...
If you do not need this level of security, you can use the xref:transports/jetty-transport-reference#[Jetty Transport Reference] instead.
