...
:page-id: mule-runtime@3.8::transports/jdbc-transport-reference
:keywords: jdbc
...
Review the xref:connectors:database/database-connector#[*Database Connector Documentation*] to read about database connector features and functionality.

*Note:* The Mule 3.8.0  link:http://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/jdbc/package-summary.html[org.mule.transport.jdbc] package documentation remains available.
====
...
[%autowidth.spread]
|===
|Docs|link:http://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/jdbc/package-summary.html[JDBC Javadoc]
...
link:http://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/transport/jdbc/package-summary.html[Javadoc for JDBC Transport]
