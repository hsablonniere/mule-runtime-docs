...
:page-id: mule-runtime@3.7::transports/sftp-transport-reference
...
. Create the **sftp.properties** properties file in your Classpath or set your PATH variable to the file's location. For information on specifying SFTP server access information for a username, password, host, and port, using Anypoint Studio, see xref:connectors:sftp/sftp-connector#[SFTP Connector]. 
...
xref:transports/file-transport-reference#[File Transport Reference]
