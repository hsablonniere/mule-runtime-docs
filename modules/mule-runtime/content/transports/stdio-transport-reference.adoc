...
:page-id: mule-runtime@3.7::transports/stdio-transport-reference
...
If you are xref:custom/internationalizing-strings#[internationalizing] your application, you can also internationalize the promptMessages and outputMessages for the STDIO connector. (This assumes that you have already created a resource bundle that contains your messages as described on that page.)
