...
:page-id: mule-runtime@3.7::transports/email-transport-reference
...
* xref:transports/imap-transport-reference#[IMAP]
* xref:transports/pop3-transport-reference#[POP3]
...
The full example code for the bookstore and errorhandler examples are included in the full link:http://www.mulesoft.org/download-mule-esb-community-edition[Mule ESB distribution].
