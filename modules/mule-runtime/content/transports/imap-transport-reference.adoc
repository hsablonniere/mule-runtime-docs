...
:page-id: mule-runtime@3.7::transports/imap-transport-reference
...
|IMAP
a|* link:http://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/email/package-summary.html[JavaDoc]
* link:http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_imap/namespace-overview.html[SchemaDoc] |image:check.png[check] |image:error.png[error] |image:error.png[error] |image:error.png[error] |image:error.png[error] |image:error.png[error] |one-way |one-way |org.mule.transport:mule-transport-imap

|IMAPS
a|* link:http://www.mulesoft.org/docs/site/3.7.0/apidocs/org/mule/transport/email/package-summary.html[JavaDoc]
* link:http://www.mulesoft.org/docs/site/current3/schemadocs/namespaces/http_www_mulesoft_org_schema_mule_imaps/namespace-overview.html[SchemaDoc] |image:check.png[check] |image:error.png[error] |image:error.png[error] |image:error.png[error] |image:error.png[error] |image:error.png[error] |one-way |one-way |org.mule.transport:mule-transport-imaps
|===
...
The IMAP connector supports all the xref:transports/configuring-a-transport#[common connector attributes and properties] and the following additional attributes:
...
IMAP and IMAPS endpoints include details about connecting to an IMAP mailbox. You can xref:endpoints/endpoint-configuration-reference#[configure the endpoints] just as you would with any other transport, with the following additional attributes:
...
For more information about transformers, see the xref:transports/email-transport-reference#[Transformers] section in the Email Transport Reference.

For more information about filters, see the xref:transports/email-transport-reference#[Filters] section in the Email Transport Reference.
...
For more information about the limitations, see the xref:transports/email-transport-reference#[Limitations] section in the Email Transport Reference.
