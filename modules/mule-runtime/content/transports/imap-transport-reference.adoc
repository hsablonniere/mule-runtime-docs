...
:page-id: mule-runtime@3.8::transports/imap-transport-reference
...
IMAP and IMAPS endpoints include details about connecting to an IMAP mailbox. You xref:endpoints/endpoint-configuration-reference#[configure the endpoints] just as you would with any other transport, with the following additional attributes:
