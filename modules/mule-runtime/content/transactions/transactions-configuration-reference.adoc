...
:page-id: mule-runtime@3.8::transactions/transactions-configuration-reference
...
For more information on how to configure transactions in flows, see xref:transactions/transaction-management#[Transaction Management].
