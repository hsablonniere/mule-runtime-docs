...
:page-id: mule-runtime@3.8::transactions/single-resource-transactions
...
Refer to xref:transactions/transaction-management#[Transaction Management] for details on how to configure a Single Resource transaction.
