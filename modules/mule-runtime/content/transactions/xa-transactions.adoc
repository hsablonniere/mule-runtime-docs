...
:page-id: mule-runtime@3.7::transactions/xa-transactions
...
[TIP]
Our default and recommended XA Transaction Manager is *Bitronix*, read xref:transactions/using-bitronix-to-manage-transactions#[Using Bitronix to Manage Transactions] for details on how to implement it in Mule.
