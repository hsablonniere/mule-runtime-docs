...
:page-id: mule-runtime@3.7::transactions/multiple-resource-transactions
...
Refer to xref:transactions/transaction-management#[Transaction Management] for details on how to configure a Multiple Resource transaction.
