...
:page-id: mule-runtime@3.8::modules/cxf-module-configuration-reference
...
This page provides reference information about the elements and attributes you can configure for the xref:modules/cxf-module-reference#[CXF Module Reference] .
