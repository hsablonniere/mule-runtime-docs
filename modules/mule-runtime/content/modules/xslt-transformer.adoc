...
:page-id: mule-runtime@3.7::modules/xslt-transformer
...
This transformer can be tested using the following functional test. Note that it uses `FunctionalTestCase`, which is part of Mule's xref:testing/functional-testing#[Test support].
