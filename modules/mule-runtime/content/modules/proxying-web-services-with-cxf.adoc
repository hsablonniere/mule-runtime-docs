...
:page-id: mule-runtime@3.7::modules/proxying-web-services-with-cxf
:keywords: cxf
...
[TIP]
Instead of building a proxy application from scratch, consider xref:anypoint-platform@latest::api-manager:setting-up-an-api-proxy#[Setting Up and Deploying a Proxy].
