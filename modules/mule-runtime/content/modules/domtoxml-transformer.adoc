...
:page-id: mule-runtime@3.8::modules/domtoxml-transformer
...
These transformers support the xref:transformers/transformers-configuration-reference#[standard transformer attributes]. In addition, they support the following configuration.
