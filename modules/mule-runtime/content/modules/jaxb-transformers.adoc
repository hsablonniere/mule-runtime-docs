...
:page-id: mule-runtime@3.7::modules/jaxb-transformers
...
Mule offers automatic xref:modules/jaxb-bindings#[JAXB Bindings] so you don't even need use these transformers for most scenarios.
