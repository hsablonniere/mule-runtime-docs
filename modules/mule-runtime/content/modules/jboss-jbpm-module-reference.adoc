...
:page-id: mule-runtime@3.7::modules/jboss-jbpm-module-reference
...
[WARNING]
This module provides a "Plug-in" for JBoss jBPM to be used with Mule's BPM support. If you have not yet read the general documentation for Mule's xref:modules/bpm-module-reference#[BPM Support], read that first and then come back to this page.
...
Refer to xref:modules/bpm-module-reference#[BPM Module Reference] for a list of general features offered by Mule's BPM support.
...
For more configuration options, refer to the link:http://docs.jboss.org/jbpm/v4/devguide/html_single/#configuration[jBPM documentation] and/or link:http://docs.jboss.org/hibernate/core/3.6/reference/en-US/html_single/#configuration-xmlconfig[Hibernate documentation].
...
This module uses the schema from the xref:modules/bpm-module-reference#[BPM Module]; it does not have its own schema.
...
Refer to xref:modules/bpm-module-reference#[BPM Module Reference] for detailed information on the elements of the BPM schema.
