...
:page-id: mule-runtime@3.7::modules/jxpath-extractor-transformer

_*Deprecated*_

[NOTE]
Mule 3.6.0 includes support for version 3.0 of the XPath standard, which is compatible with XPath 2.0. As part of this upgrade, the JXPath extractor transformer has been deprecated in favor of the `xpath3` function. For details, see xref:modules/xml-module-reference#[XML Module Reference].
