...
:page-id: mule-runtime@3.8::modules/cxf-module-overview
...
For information about what standards are supported, see xref:modules/supported-web-service-standards#[Supported Web Service Standards].
