...
:page-id: mule-runtime@3.7::modules/using-a-web-service-client-directly
:keywords: cxf

This page describes how to use a standalone CXF-generated client with Mule. This approach is different from the xref:modules/consuming-web-services-with-cxf#[outbound router] approach, which is typically a more appropriate fit for most applications.
...
Following is an example of how to construct a client using the service that was developed in xref:modules/building-web-services-with-cxf#[Building Web Services with CXF]:
...
* link:https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=2853210[CXF Maven plugin]
