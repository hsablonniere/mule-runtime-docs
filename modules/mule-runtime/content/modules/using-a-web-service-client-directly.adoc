...
:page-id: mule-runtime@3.8::modules/using-a-web-service-client-directly
:keywords: cxf
...
* link:http://cwiki.apache.org/CXF20DOC/maven-integration-and-plugin.html[CXF Maven plugin]
