...
[NOTE]
====
To use the object Store module in Anypoint Studio, you must first download the *Object Store Connector* from the xref:anypoint-platform@latest::exchange:anypoint-exchange#[Anypoint Exchange].
====
...
* xref:anypoint-platform@latest::runtime-manager:managing-application-data-with-object-stores#[Managing Application Data Storage with Object Stores]
