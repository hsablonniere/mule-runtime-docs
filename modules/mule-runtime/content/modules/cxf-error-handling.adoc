...
:page-id: mule-runtime@3.7::modules/cxf-error-handling
...
The sections below describe how to use Mule's xref:exceptions/error-handling#[*Default Exception Strategy*], a xref:exceptions/rollback-exception-strategy#[*Rollback Exception Strategy*] or a xref:exceptions/catch-exception-strategy#[*Catch Exception Strategy*] to handle errors in a flow with a CXF Web service.
...
Refer to xref:exceptions/rollback-exception-strategy#[Rollback Exception Strategy] for detailed instructions on how to apply one to a flow.
...
Refer to xref:exceptions/catch-exception-strategy#[Catch Exception Strategy] for detailed instructions on how to apply one to a flow.
