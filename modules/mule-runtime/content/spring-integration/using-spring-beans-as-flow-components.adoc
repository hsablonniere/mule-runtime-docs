...
:page-id: mule-runtime@3.8::spring-integration/using-spring-beans-as-flow-components
...
For more information on component configuration, see xref:components/configuring-components#[Configuring Components]. For more information on the elements you use to configure components, see xref:components/component-configuration-reference#[Component Configuration Reference].
