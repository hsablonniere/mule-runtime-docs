...
:page-id: mule-runtime@3.7::spring-integration/using-mule-with-spring
...
xref:@3.8::mule-configuration/about-the-xml-configuration-file#[About the XML Configuration File]
...
[TIP]
See xref:@3.8::spring-integration/spring-application-contexts#[Spring Application Contexts]
...
xref:@3.8::spring-integration/using-spring-beans-as-flow-components#[Using Spring Beans as Flow Components]
