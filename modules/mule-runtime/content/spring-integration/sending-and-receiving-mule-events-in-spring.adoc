...
:page-id: mule-runtime@3.8::spring-integration/sending-and-receiving-mule-events-in-spring
...
The inbound endpoints can be any valid xref:endpoints/endpoint-configuration-reference#[Mule Endpoint], so you can receive JMS messages, SOAP requests, files, HTTP and servlet requests, TCP, multicast, and more.
