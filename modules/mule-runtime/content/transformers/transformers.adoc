...
:page-id: mule-runtime@3.8::transformers/transformers
...
NOTE: The DataMapper transformer has been deprecated. Use xref:dataweave/dataweave#[DataWeave] instead.
...
|image:javascript-transformer-icon.png[JavaScript icon] |JavaScript |Implements a JavaScript transformer backed by a JavaScript script engine. See xref:transformers/script-transformer-reference#[Script Transformer Reference].
|image:python-transformer-icon.png[Python icon] |Python |Implements a script transformer backed by a Python script engine. See xref:transformers/script-transformer-reference#[Script Transformer Reference].
|image:ruby-transformer-icon.png[Ruby icon] |Ruby |Implements a script transformer backed by a Ruby script engine. See  xref:transformers/script-transformer-reference#[Script Transformer Reference]
|image:script-transformer-icon.png[Script icon] |Script |Implements a script transformer backed by a JSR-223- compliant script engine, such as a Groovy, Javascript, Python, or Ruby. See xref:transformers/script-transformer-reference#[Script Transformer Reference].
|===
...
*Documentation*: xref:transformers/java-transformer-reference#[Java Transformer Reference]
...
*Documentation*: xref:transformers/object-to-xml-transformer-reference#[Object-to-XML Transformer Reference]
...
*Documentation*: xref:modules/domtoxml-transformer#[DOM/XML Transformers]
...
*Documentation*: xref:transformers/append-string-transformer-reference#[Append String Transformer Reference]
...
*Documentation*: xref:transformers/expression-transformer-reference#[Expression Transformer Reference]
...
*Documentation*: xref:transformers/xslt-transformer-reference#[Transformer Reference]
|image:xslt-transformer-icon.png[xslt-transformer-icon] |XSLT |Transforms XML using XSLT.

*Documentation*: xref:transformers/xslt-transformer-reference#[XSLT Transformer Reference]
|===
...
*Documentation*: xref:transformers/attachment-transformer-reference#[Attachment Transformer Reference]
...
*Documentation*: xref:transformers/property-transformer-reference#[Property Transformer Reference]
...
*Documentation*: xref:transformers/variable-transformer-reference#[Variable Transformer Reference]
...
*Documentation*: xref:transformers/session-variable-transformer-reference#[Session Variable Transformer Reference]
|===
...
The transformers below are all related to the deprecated link:/mule-user-guide/v/3.8/http-connector-deprecated[endpoint-based HTTP Connector]. They have all been made unnecessary, as the new xref:connectors:http/http-connector#[HTTP Connector]'s features cover the use cases these were built to serve.
