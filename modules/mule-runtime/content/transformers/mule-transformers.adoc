...
:page-id: mule-runtime@3.8::transformers/mule-transformers
...
* *NEXT STEP*: Read on about xref:mule-filters-scopes-and-routers#[Filters, Scopes, and Routers].
...
* Learn more about setting, then using xref:messages/about-mule-message#[properties and variables].
