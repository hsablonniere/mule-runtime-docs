...
:page-id: mule-runtime@3.7::transformers/expression-transformer-reference
...
The default value in the *Expression* field is **`#[]`**. You need to type a valid expression within the square brackets. For syntax details see the xref:mel/mule-expression-language-mel#[Mule Expression Language MEL] documentation.
