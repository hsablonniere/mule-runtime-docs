...
:page-id: mule-runtime@3.8::transformers/expression-transformer-reference
...
[NOTE]
--
The default value in the *Expression* field is `#[]`. You need to type a valid expression without the square brackets. For syntax details see the xref:mel/mule-expression-language-mel#[Mule Expression Language MEL] documentation.
--
