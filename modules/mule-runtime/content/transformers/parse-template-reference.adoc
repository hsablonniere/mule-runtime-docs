...
:page-id: mule-runtime@3.7::transformers/parse-template-reference
...
* Learn how to use xref:mel/mule-expression-language-mel#[Mule Expression Language (MEL)] to read session variables using the `sessionVars` map.