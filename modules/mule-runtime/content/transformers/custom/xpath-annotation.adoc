...
:page-id: mule-runtime@3.8::transformers/custom/xpath-annotation
...
Namespaces can be configured in the Mule Configuration using the xref:mule-configuration/xml-namespaces#[XML Namespaces], these will be made available for this annotation.

First declare the namespace using the xref:mule-configuration/xml-namespaces#[Namespace Manager] -
