...
:page-id: mule-runtime@3.7::transformers/custom/creating-flow-objects-and-transformers-using-annotations
...
This page assumes you are familiar with Java annotations (marked with an @). For a brief overview of annotations, see the  link:http://docs.oracle.com/javase/tutorial/java/annotations/[Java annotations tutorial]. For annotations used in the Anypoint Connector DevKit, see the xref:anypoint-connector-devkit@3.7::annotation-reference#[Annotations Reference].
