...
:page-id: mule-runtime@3.8::transformers/custom/outboundattachments-annotation
...
There are no parameters for this annotation and the parameter must be `java.util.Map<String, DataHandler>`. Any outbound attachments set by previous elements in a xref:flows/using-flows-for-service-orchestration#[Flow] will be accessible and writable in this map.
