...
:page-id: mule-runtime@3.8::transformers/custom/creating-custom-transformer-classes
...
Access xref:transformers/custom/transformer-annotation#[Transformer Annotation] if you are looking for information about creating a transformer with the Transformer Annotation.
