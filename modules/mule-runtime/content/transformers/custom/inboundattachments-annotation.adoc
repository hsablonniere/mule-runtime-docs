...
:page-id: mule-runtime@3.7::transformers/custom/inboundattachments-annotation
:keywords: annotations, custom java code, inbound attachments

This annotation controls how the current message inbound attachments are passed into a method. The annotation supports, Map, List, single attachment, wildcards and optional entries. It can be used on component entry points and xref:transformers/custom/transformer-annotation#[@Transformer] methods.
