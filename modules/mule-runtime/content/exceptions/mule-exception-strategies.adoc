...
:page-id: mule-runtime@3.8::exceptions/mule-exception-strategies
...
* A xref:transactions/transaction-management#[Transactional Scope] may include its own exception strategy, regardless of what you define at Flow level.
...
* *NEXT STEP*: Read on about the structure of a xref:messages/about-mule-message#[Mule message].
* See the xref:anypoint-platform@latest::exchange:anypoint-exchange#[examples].
* Learn more about configuring the xref:exceptions/catch-exception-strategy#[catch], xref:exceptions/rollback-exception-strategy#[rollback], xref:exceptions/reference-exception-strategy#[reference], and xref:exceptions/choice-exception-strategy#[choice] exception strategies.
