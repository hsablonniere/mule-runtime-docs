...
:page-id: mule-runtime@3.8::exceptions/rollback-exception-strategy
...
You can create one or more xref:exceptions/error-handling#[global exception strategies] to reuse in flows throughout your entire Mule application. First, create a Mule Configuration File and add to it your global rollback exception strategy. Then add a xref:exceptions/reference-exception-strategy#[Reference Exception Strategy] to a flow to apply the error handling behavior of your new global rollback exception strategy.
...
Use a xref:exceptions/reference-exception-strategy#[reference exception strategy] to instruct a flow to employ the error handling behavior defined by your global rollback exception strategy in your Mule configuration file. In other words, you must ask your flow to refer to the global rollback exception strategy in the configuration file for instructions on how to handle errors.
