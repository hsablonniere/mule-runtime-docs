...
:page-id: mule-runtime@3.8::exceptions/error-handling
...
|xref:exceptions/catch-exception-strategy#[Catch exception strategy] |Define a catch exception strategy to customize the way Mule handles any exception. Catch exception strategies consume inbound messages. |When a message throws an exception, the catch exception strategy _always_ commits the transaction and consumes the message.
...
Consult the individual xref:exceptions/catch-exception-strategy#[catch], xref:exceptions/rollback-exception-strategy#[rollback] or xref:exceptions/choice-exception-strategy#[choice] exception strategy pages for details on how to create them globally; consult the xref:exceptions/reference-exception-strategy#[reference] exception strategy page for details on how to reuse them globally.
...
* xref:exceptions/catch-exception-strategy#[Catch Exception Strategy]

* xref:exceptions/choice-exception-strategy#[Choice Exception Strategy]

* xref:exceptions/rollback-exception-strategy#[Rollback Exception Strategy]
...
Web services that utilize CXF can implement Mule exception strategies (such as the Catch and Rollback exception strategies) that are compatible with CXF. Consult the xref:modules/cxf-error-handling#[CXF Error Handling documentation] for details.

== See Also

* To understand how to configure Mule’s exception strategies to handle the most common error handling use cases, read xref:exceptions/exception-strategy-most-common-use-cases#[Exception Strategy Most Common Use Cases].
