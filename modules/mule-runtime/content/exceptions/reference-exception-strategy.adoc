...
:page-id: mule-runtime@3.8::exceptions/reference-exception-strategy
...
. If you have not already done so, create a configuration file as described in the xref:exceptions/catch-exception-strategy#[catch], xref:exceptions/rollback-exception-strategy#[rollback], or xref:exceptions/choice-exception-strategy#[choice] exception strategy to which your reference exception strategy can refer.
