...
:page-id: mule-runtime@3.7::exceptions/reference-exception-strategy
...
. If you have not already done so, create a *global* xref:exceptions/catch-exception-strategy#[catch], xref:exceptions/rollback-exception-strategy#[rollback], or xref:exceptions/choice-exception-strategy#[choice] exception strategy to which your reference exception strategy can refer.
