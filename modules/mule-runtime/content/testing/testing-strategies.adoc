...
:page-id: mule-runtime@3.7::testing/testing-strategies
...
Mule provides abstract parent classes to help with unit testing. Turn xref:testing/unit-testing#[here] for more information about them.
...
The FTC supports plenty of configuration options. Read more about it there: xref:testing/functional-testing#[Functional Testing].
