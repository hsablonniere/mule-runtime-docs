...
:page-id: mule-runtime@3.7::testing/introduction-to-testing-mule
...
Mule ESB provides legacy tools for testing your custom Mule applications using Java code. These tools provide the testing functionality but lack some features provided by MUnit, such as link:/munit/v/1.1.1/mock-message-processor[mocking].
...
Mule also offers tools like the xref:testing/profiling-mule#[Profiler Pack] designed to assist in identifying memory leaks in your custom Mule ESB extensions.
