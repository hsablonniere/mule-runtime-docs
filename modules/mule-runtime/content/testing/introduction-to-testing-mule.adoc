...
:page-id: mule-runtime@3.8::testing/introduction-to-testing-mule
...
Mule also offers tools like the xref:testing/profiling-mule#[Profiler Pack] designed to assist in identifying memory leaks in your custom Mule extensions.
