...
:page-id: mule-runtime@3.7::flows/about-mule-flows
...
Typically, a message source comes in the form of an xref:connectors:anypoint-connectors#[*Anypoint Connector*]. 
