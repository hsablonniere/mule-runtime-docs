...
:page-id: mule-runtime@3.7::mule-configuration/global-elements
...
 xref:anypoint-studio@5::about-anypoint-studio#[Visual Editor in Anypoint Studio]. Review the xref:anypoint-studio@5::about-anypoint-studio#[Anypoint Studio Essentials] document to learn more about developing with Mule's graphical user interface.
...
* *NEXT STEP:* Use what you've learned to follow the xref:anypoint-studio@5::basic-studio-tutorial#[Basic Studio Tutorial]. 