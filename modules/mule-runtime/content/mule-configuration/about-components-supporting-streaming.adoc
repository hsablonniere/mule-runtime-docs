...
:page-id: mule-runtime@3.7::mule-configuration/about-components-supporting-streaming
...
* xref:anypoint-studio@5::datamapper/streaming-data-processing-with-datamapper#[DataMapper]
