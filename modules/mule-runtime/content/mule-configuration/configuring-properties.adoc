...
:page-id: mule-runtime@3.7::mule-configuration/configuring-properties
...
For information on configuration builders, see xref:mule-configuration/about-configuration-builders#[About Configuration Builders].
...
If you deploy your application to link:/cloudhub[CloudHub], you can also set properties through the Runtime Manager console. These can be defined when xref:anypoint-platform@latest::runtime-manager:deploying-to-cloudhub#[Deploying to CloudHub], or on an xref:anypoint-platform@latest::cloudhub:managing-applications-on-cloudhub#[already running application].
...
See xref:anypoint-platform@latest::cloudhub:managing-applications-on-cloudhub#[Managing Applications on CloudHub] and xref:anypoint-platform@latest::runtime-manager:secure-application-properties#[Secure Application Properties] for more details.
