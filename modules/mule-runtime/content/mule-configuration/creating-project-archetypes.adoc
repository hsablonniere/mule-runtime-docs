...
:page-id: mule-runtime@3.8::mule-configuration/creating-project-archetypes
...
[TIP]
To create an APIKit project using an APIKit archetype check the xref:apikit@3.8.3::creating-an-apikit-project-with-maven#[Creating APIKit projects with Maven].
