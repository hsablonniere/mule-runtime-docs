...
:page-id: mule-runtime@3.7::mule-configuration/schema-documentation
...
If you are familiar with versions of Mule older than v 3.0, you may want to consult this list of xref:mule-configuration/notes-on-mule-3.0-schema-changes#[schema changes].
...
* link:http://www.mulesoft.org/docs/site/3.7.0/apidocs/[API Docs]
* link:http://www.mulesoft.org/docs/site/3.7.0/testapidocs/[Test API Docs]
