...
:page-id: mule-runtime@3.8::mule-configuration/schema-documentation
...
If you are familiar with versions of Mule older than v3.0, you may want to consult this list of xref:mule-configuration/notes-on-mule-3.0-schema-changes#[schema changes].
