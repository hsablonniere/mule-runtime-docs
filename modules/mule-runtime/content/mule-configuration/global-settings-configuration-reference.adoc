...
:page-id: mule-runtime@3.8::mule-configuration/global-settings-configuration-reference
:keywords: configure, finetune, global, global settings

This page provides details on the global settings you configure at the root level of a Mule configuration. For more information on configuration, see link:/mule-user-guide/v/3.8/about-mule-configuration[About Mule Configuration]. For information on threading profiles, see xref:administer/tuning-performance#[Tuning Performance].
