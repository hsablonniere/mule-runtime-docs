...
:page-id: mule-runtime@3.8::mule-configuration/about-the-xml-configuration-file
...
* xref:spring-integration/using-mule-with-spring#[Using Mule with Spring]
* Learn how Mule creates an application context. See xref:spring-integration/spring-application-contexts#[Spring Application Contexts]
