...
:page-id: mule-runtime@3.7::mule-configuration/about-configuration-builders
...
AutoConfigurationBuilder is the default configuration builder. If you want to use another configuration builder, you can specify it in the xref:deploy/mule-application-deployment-descriptor#[deployment descriptor] of an application.
