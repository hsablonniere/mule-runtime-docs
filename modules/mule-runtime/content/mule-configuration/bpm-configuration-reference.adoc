...
:page-id: mule-runtime@3.8::mule-configuration/bpm-configuration-reference
:keywords: connectors, anypoint, studio, esb, bpm

This page provides details on the process components you configure for BPM. Some of this information is pulled directly from `mule-bpm.xsd` and is cached. For more information on BPM, see xref:modules/bpm-module-reference#[BPM Module Reference]. Information on jBPM is available at link:http://www.jbpm.org.
...
See xref:exceptions/exception-strategy-configuration-reference#[Exception Strategy Configuration Reference].

== Entry Point Resolver

See xref:components/entry-point-resolver-configuration-reference#[Entry Point Resolver Configuration Reference].
