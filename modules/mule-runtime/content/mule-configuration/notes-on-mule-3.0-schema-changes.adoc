...
:page-id: mule-runtime@3.7::mule-configuration/notes-on-mule-3.0-schema-changes
...
* In addition to services, message processing can be configured using xref:flows/using-flows-for-service-orchestration#[flows].
== BPM
