...
:page-id: mule-runtime@3.7::mule-configuration/mule-versus-web-application-server
...
* Investigate different xref:deploy/deployment-scenarios#[Deployment Scenarios].
