...
:page-id: mule-runtime@3.8::mule-configuration/mule-versus-web-application-server
...
* xref:anypoint-studio@6::download-and-launch-anypoint-studio#[Download, then install and launch Anypoint Studio].
* Browse different xref:deploy/deployment-scenarios#[Mule Runtime Standalone Deployment Scenarios].
