...
:page-id: mule-runtime@3.7::mule-configuration/improving-performance-with-the-kryo-serializer
...
Unlike the other cases, the local persistent ObjectStore doesn’t show much improvement because of high contention on the ObjectStore implementation which pretty much absorbes all the gain.
