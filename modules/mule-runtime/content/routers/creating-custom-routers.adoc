...
:page-id: mule-runtime@3.8::routers/creating-custom-routers
...
The easiest way to write an outbound router is to extend the link:http://www.mulesoft.org/docs/site/3.8.0/apidocs/org/mule/routing/outbound/AbstractOutboundRouter.html[org.mule.routing.outbound.AbstractOutboundRouter] class:
