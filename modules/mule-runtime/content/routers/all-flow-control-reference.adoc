...
:page-id: mule-runtime@3.8::routers/all-flow-control-reference
...
Access the documentation for the xref:routers/scatter-gather#[Scatter-Gather flow control] to take advantage of the newly-designed functionality.
====
