...
:page-id: mule-runtime@3.8::mule-filters-scopes-and-routers
...
* *NEXT STEP*: Read on about xref:exceptions/mule-exception-strategies#[exception strategies].
* Skip ahead to understand the structure of a xref:messages/about-mule-message#[Mule message].
* View xref:anypoint-platform@latest::exchange:anypoint-exchange#[examples].
