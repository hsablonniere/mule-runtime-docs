...
:page-id: mule-runtime@3.8::object-scopes/dependency-injection
:keywords: dependency injection, deploy

This guide helps you use link:https://en.wikipedia.org/wiki/Dependency_injection[dependency injection]. For registry information, see xref:object-scopes/unifying-the-mule-registry#[Unifying the Mule Registry].
